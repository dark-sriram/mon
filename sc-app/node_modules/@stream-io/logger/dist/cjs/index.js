...
exports.restoreDefaults = exports.configureLoggers = exports.getLogger = exports.LogLevelEnum = void 0;
const is_react_native_ts_1 = require("./utils/is-react-native.js");
var LogLevelEnum;
...
const logToConsole = (logLevel, message, ...rest) => {
    ...
    switch (logLevel) {
        case "error":
            if ((0, is_react_native_ts_1.isReactNative)()) {
...
const getLogger = (scope, options = {}) => {
    ...
    return {
        withExtraTags: (...extraTags) => {
            return (0, exports.getLogger)(scope, {
                ...options,
